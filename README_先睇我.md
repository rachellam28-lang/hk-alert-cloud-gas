...
- 星期一至五 17:05、17:30、17:55、18:20：半年 / 12 個月 / 2 年 / 3 年 POC 突破（分 4 批自動跑完全市場）

## POC 分批自動掃描

POC 全市場（約 2700 隻）+ 4 個窗口（半年／1 年／2 年／3 年）+ 圖片產生會超過單個 GitHub Actions job 的時間。所以 POC 已經自動分成 4 個 shard：每個 shard 只掃 1/4 的股票，在收市後分時段排程。一日跑完所有股票，毋須人手介入。
